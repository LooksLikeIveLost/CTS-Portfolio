...
10.times do |blog|
  Blog.create!(
    ...
    velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur? Oh hellow there!”
  )
end
...
9.times do |portfolio_item|
  Portfolio.create!(
    ...
    proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Onion",
